...
const PERMISSIONS = [
  { name: 'Rooms Read', code: 'rooms:read', slug: 'rooms:read', description: 'View rooms' },
  { name: 'Rooms Create', code: 'rooms:create', slug: 'rooms:create', description: 'Add new rooms' },
  { name: 'Rooms Update', code: 'rooms:update', slug: 'rooms:update', description: 'Edit room details' },
  { name: 'Rooms Delete', code: 'rooms:delete', slug: 'rooms:delete', description: 'Remove rooms' },
  { name: 'Rooms Status', code: 'rooms:status', slug: 'rooms:status', description: 'Change room status' },
  { name: 'Room Types Read', code: 'room_types:read', slug: 'room_types:read', description: 'View room types' },
  { name: 'Room Types Create', code: 'room_types:create', slug: 'room_types:create', description: 'Add room types' },
  { name: 'Room Types Update', code: 'room_types:update', slug: 'room_types:update', description: 'Edit room types' },
  { name: 'Room Types Delete', code: 'room_types:delete', slug: 'room_types:delete', description: 'Delete room types' },
  { name: 'Bookings Read', code: 'bookings:read', slug: 'bookings:read', description: 'View bookings' },
  { name: 'Bookings Create', code: 'bookings:create', slug: 'bookings:create', description: 'Create bookings' },
  { name: 'Bookings Update', code: 'bookings:update', slug: 'bookings:update', description: 'Modify bookings' },
  { name: 'Bookings Cancel', code: 'bookings:cancel', slug: 'bookings:cancel', description: 'Cancel bookings' },
  { name: 'Bookings Checkin', code: 'bookings:checkin', slug: 'bookings:checkin', description: 'Check-in guests' },
  { name: 'Bookings Checkout', code: 'bookings:checkout', slug: 'bookings:checkout', description: 'Check-out guests' },
  { name: 'Bookings Confirm', code: 'bookings:confirm', slug: 'bookings:confirm', description: 'Confirm booking holds' },
  { name: 'Guests Read', code: 'guests:read', slug: 'guests:read', description: 'View guest profiles' },
  { name: 'Guests Create', code: 'guests:create', slug: 'guests:create', description: 'Create guest profiles' },
  { name: 'Guests Update', code: 'guests:update', slug: 'guests:update', description: 'Edit guest profiles' },
  { name: 'Guests Delete', code: 'guests:delete', slug: 'guests:delete', description: 'Delete guest profiles' },
  { name: 'Guests PII Read', code: 'guests:pii:read', slug: 'guests:pii:read', description: 'View guest PII data' },
  { name: 'Pricing Read', code: 'pricing:read', slug: 'pricing:read', description: 'View pricing' },
  { name: 'Pricing Manage', code: 'pricing:manage', slug: 'pricing:manage', description: 'Manage rate plans' },
  { name: 'Pricing Promotions', code: 'pricing:promotions', slug: 'pricing:promotions', description: 'Manage promotions' },
  { name: 'Pricing Overrides', code: 'pricing:overrides', slug: 'pricing:overrides', description: 'Manage price overrides' },
  { name: 'Pricing Seasonal', code: 'pricing:seasonal', slug: 'pricing:seasonal', description: 'Manage seasonal rates' },
  { name: 'Invoices Read', code: 'invoices:read', slug: 'invoices:read', description: 'View invoices' },
  { name: 'Invoices Create', code: 'invoices:create', slug: 'invoices:create', description: 'Generate invoices' },
  { name: 'Payments Read', code: 'payments:read', slug: 'payments:read', description: 'View payments' },
  { name: 'Payments Process', code: 'payments:process', slug: 'payments:process', description: 'Process payments' },
  { name: 'Payments Refund', code: 'payments:refund', slug: 'payments:refund', description: 'Process refunds' },
  { name: 'Reports View', code: 'reports:view', slug: 'reports:view', description: 'View financial reports' },
  { name: 'Ledger Read', code: 'ledger:read', slug: 'ledger:read', description: 'View ledger entries' },
  { name: 'Tax Manage', code: 'tax:manage', slug: 'tax:manage', description: 'Manage tax rules' },
  { name: 'Housekeeping Read', code: 'housekeeping:read', slug: 'housekeeping:read', description: 'View housekeeping tasks' },
  { name: 'Housekeeping Assign', code: 'housekeeping:assign', slug: 'housekeeping:assign', description: 'Assign housekeeping tasks' },
  { name: 'Housekeeping Update', code: 'housekeeping:update', slug: 'housekeeping:update', description: 'Update housekeeping task status' },
  { name: 'Maintenance Read', code: 'maintenance:read', slug: 'maintenance:read', description: 'View maintenance tickets' },
  { name: 'Maintenance Create', code: 'maintenance:create', slug: 'maintenance:create', description: 'Create maintenance tickets' },
  { name: 'Maintenance Update', code: 'maintenance:update', slug: 'maintenance:update', description: 'Update maintenance tickets' },
  { name: 'Maintenance Resolve', code: 'maintenance:resolve', slug: 'maintenance:resolve', description: 'Resolve maintenance tickets' },
  { name: 'Staff Read', code: 'staff:read', slug: 'staff:read', description: 'View staff members' },
  { name: 'Staff Manage', code: 'staff:manage', slug: 'staff:manage', description: 'Manage staff profiles' },
  { name: 'Shifts Read', code: 'shifts:read', slug: 'shifts:read', description: 'View shift schedules' },
  { name: 'Shifts Manage', code: 'shifts:manage', slug: 'shifts:manage', description: 'Manage shift assignments' },
  { name: 'Hotel Settings', code: 'hotel:settings', slug: 'hotel:settings', description: 'Manage hotel settings' },
  { name: 'Platform Impersonate', code: 'platform:impersonate', slug: 'platform:impersonate', description: 'Impersonate hotel accounts for support' },
  { name: 'Platform Manage', code: 'platform:manage', slug: 'platform:manage', description: 'Full platform management' },
];
...
const ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'staff:read', 'shifts:read', 'shifts:manage', 'hotel:settings',
    ],
  },
  {
    ...
    scope: RoleScope.HOTEL,
    permissions: [
      'rooms:read', 'room_types:read', 'bookings:read',
      'pricing:read', 'pricing:manage', 'pricing:promotions', 'pricing:overrides', 'pricing:seasonal',
      'reports:view', 'invoices:read',
    ],
  },
  {
    name: 'FRONT_DESK',
    ...
    scope: RoleScope.HOTEL,
    permissions: [
      'rooms:read', 'rooms:status', 'room_types:read',
      'bookings:read', 'bookings:create', 'bookings:update', 'bookings:cancel',
      'bookings:checkin', 'bookings:checkout', 'bookings:confirm',
      'guests:read', 'guests:create', 'guests:update', 'guests:pii:read',
    ],
  },
  {
    name: 'ACCOUNTANT',
    ...
    scope: RoleScope.HOTEL,
    permissions: [
      'invoices:read', 'invoices:create', 'payments:read', 'payments:process', 'payments:refund',
      'reports:view', 'ledger:read', 'tax:manage', 'bookings:read', 'guests:read',
    ],
  },
  {
    ...
    scope: RoleScope.HOTEL,
    permissions: [
      'rooms:read', 'housekeeping:read', 'housekeeping:assign', 'housekeeping:update',
      'staff:read', 'staff:manage', 'shifts:read', 'shifts:manage',
  ...
  },
  {
    ...
    scope: RoleScope.HOTEL,
    permissions: ['rooms:read', 'maintenance:read', 'maintenance:create', 'maintenance:update'],
  },
];
...
async function bootstrap() {
  ...
  try {
    ...
    let superAdmin = await userRepo.findOne({ where: { email: 'admin@platform.com' } });
    if (!superAdmin) {
    ...
    let hotelAdmin = await userRepo.findOne({ where: { email: 'admin@hotels.com' } });
    if (!hotelAdmin) {
      hotelAdmin = await userRepo.save(userRepo.create({
    ...
    for (const hc of HOTELS) {
      ...
      const ratePlans = [
        ...
        { name: 'Weekend Getaway', description: 'Weekend special', weekdayAdjustment: 0, weekendAdjustment: 0.1 },
        { name: 'Premium Rate', description: 'Premium service rate', weekdayAdjustment: 0.25, weekendAdjustment: 0.3 },
      ];
      ...
      if (savedRooms.length > 1) {
        ...
        const exists = await maintenanceRepo.findOne({ where: { roomId: room.id, status: TicketStatus.REPORTED } });
        if (!exists) {
    ...
    for (const hc of HOTELS) {
      console.log(`\n   ${hc.name}:`);
      for (const roleDef of ROLES) {
        console.log(`     ${roleDef.name}: ${roleDef.name.toLowerCase()}@${hc.slug}.com / Admin123!`);
      }
    }
    console.log('\n=== Seed Complete! ===\n');
  } catch (error) {
